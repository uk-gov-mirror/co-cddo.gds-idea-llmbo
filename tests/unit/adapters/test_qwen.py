...
from llmbo.adapters import QwenAdapter
from llmbo.models import ModelInput


def test_build_tool():
    """Test building a tool definition for Qwen."""
    tool = QwenAdapter.build_tool(ExampleOutput)
...
def test_prepare_model_input():
    ...
    result = QwenAdapter.prepare_model_input(model_input)
...
def test_prepare_model_input_with_tool():
    ...
    result = QwenAdapter.prepare_model_input(model_input, ExampleOutput)
...
def test_validate_result_valid():
    ...
    result = QwenAdapter.validate_result(valid_result, ExampleOutput)
...
def test_validate_result_empty():
    ...
    result = QwenAdapter.validate_result({}, ExampleOutput)
